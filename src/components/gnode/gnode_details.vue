    ...
    <q-layout>
      ...
      <q-page-container class="detail-page">
        <div class="layout-padding">
          ...
          <p class="break-all">{{ node.gnode_pubkey }}</p>
          ...
          <div class="info row justify-between">
            <div class="infoBox">
              <div class="infoBoxContent">
                ...
                <div class="value">
                  <span
                    ><FormatGyuanx :amount="node.staking_requirement" raw-value
                  /></span>
                </div>
              </div>
            </div>
            <div class="infoBox">
              <div class="infoBoxContent">
                ...
                <div class="value">
                  <span
                    ><FormatGyuanx :amount="node.total_contributed" raw-value
                  /></span>
                </div>
              </div>
            </div>
          ...
          <q-list no-border :dark="theme == 'dark'" class="gyuanx-list">
            ...
            >
              <q-item-label>
                ...
                <q-item-label class="non-selectable" caption>
                  ...
                  <FormatGyuanx :amount="contributor.amount" raw-value />
                </q-item-label>
              </q-item-label>
              <ContextMenu
...
export default {
  ...
  computed: mapState({
    ...
    unlock_status: state => state.gateway.gnode_status.unlock,
    is_ready() {
