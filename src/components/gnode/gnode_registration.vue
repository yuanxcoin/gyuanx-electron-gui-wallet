<template>
  <div class="service-node-registration">
    <div class="q-pa-md">
      ...
      >
        <b place="registerCommand">register_gnode</b>
...
export default {
  ...
  computed: mapState({
    ...
    registration_status: state => state.gateway.gnode_status.registration
  }),
  validations: {
    ...
    async register() {
      ...
      passwordDialog
        .onOk(password => {
          ...
          this.$gateway.send("wallet", "register_gnode", {
            password,
