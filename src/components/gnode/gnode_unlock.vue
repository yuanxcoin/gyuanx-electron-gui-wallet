...
import { gnode_key } from "src/validators/common";
...
export default {
  ...
  computed: mapState({
    ...
    gnodes(state) {
      let nodes = state.gateway.daemon.gnodes.nodes;
