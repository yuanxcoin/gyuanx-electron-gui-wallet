export default {
  ...
  menuItems: {
    ...
    exit: "Quitter le portefeuille Gyuanx GUI",
  ...
  notification: {
    ...
    warnings: {
      ...
      usingRemoteNode: "gyuanxd introuvable, utilisation du nœud distant"
    }
  },
  placeholders: {
  ...
  strings: {
    ...
    gyuanxBalance: "Solde",
    gyuanxUnlockedBalance: "Solde débloqué",
    gyuanxUnlockedShort: "Débloqué",
